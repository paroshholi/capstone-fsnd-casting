...
# ---------------------------------------------------------
    ...
    # Home page to display API information
    @app.route('/', methods=['GET'])
    def home():
        welcome_message = "<h1>Welcome to the Casting Agency API!</h1>"
        endpoints_info = "<h2>Available Endpoints:</h2>" \
                        "<ul>" \
                        "<li>Actors: <a href='/actors'>/actors</a> - Get the list of actors</li>" \
                        "<li>Movies: <a href='/movies'>/movies</a> - Get the list of movies</li>" \
                        "</ul>"
